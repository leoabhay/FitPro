...
function App() {
  ...
  const loadData = async () => {
    ...
    setActivities(acts);
    setDietEntries(diets);
    setGoals(gls);
    setProfile(prof);
    const waterAmount = water.reduce((sum, log) => sum + log.amount, 0);
  ...
  const totalCaloriesConsumed = dietEntries.reduce(
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-blue-500/30">
      ...
      <aside className="fixed left-0 top-0 bottom-0 w-24 hidden lg:flex flex-col items-center py-10 bg-slate-900/50 border-r border-white/5 backdrop-blur-3xl z-50">
        <div
          className="w-12 h-12 bg-linear-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center font-black text-white text-xl shadow-lg shadow-blue-500/20 mb-12 cursor-pointer"
        ...
        <nav className="flex flex-col gap-8">
          {[
            ...
            <button
              key={item.id}
              onClick={() =>
                item.type === "tab" ? setActiveTab(item.id) : item.action?.()
              }
            ...
            <div className="grid gap-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-linear-to-br from-blue-600 to-blue-700 p-6 rounded-4xl shadow-xl shadow-blue-500/10 relative overflow-hidden group">
                  ...
                  <p className="text-blue-100 font-bold mb-1 uppercase tracking-wider text-[10px]">
                    Calories Burned
                  </p>
                  <div className="flex items-end gap-2 text-white">
                    ...
                    <span className="text-lg font-bold opacity-80 mb-1 text-blue-200">
                      kcal
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-slate-900 border border-white/5 p-6 rounded-4xl shadow-xl relative overflow-hidden group">
                  <p className="text-slate-500 font-bold mb-1 uppercase tracking-wider text-[10px]">
                    Calories Consumed
                  </p>
                  <div className="flex items-end gap-2 text-white">
                    <span className="text-5xl font-black">
                    ...
                    <span className="text-lg font-bold text-emerald-400 mb-1">
                      kcal
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-slate-900 border border-white/5 p-6 rounded-4xl shadow-xl relative overflow-hidden group">
                  ...
                  <div className="flex items-end gap-2 text-white">
                    ...
                    <span className="text-lg font-bold text-cyan-400 mb-1">
                      L
                    </span>
                  </div>
                </div>
                      ...
                      {activities.length === 0 ? (
                        ...
                        activities
                          ...
                          .map((a, i) => (
                            <div
                              key={i}
                              className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/5 group hover:bg-white/8 transition-all"
                            >
                              <div className="flex items-center gap-4">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-linear-to-br from-indigo-600 to-purple-700 p-8 rounded-[2.5rem] text-white shadow-xl shadow-indigo-500/10 relative overflow-hidden group">
                    ...
                    <p className="text-indigo-100 font-medium text-sm leading-relaxed mb-6">
                      Drinking water before meals can help with weight loss and
                      improve digestion. Aim for 8 glasses a day!
                    </p>
                    <button
